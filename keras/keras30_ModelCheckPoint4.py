...
# date함수는 시간을 출력하는 함수다. 
# 시간이 출력이 됨으로 내가 언제 만들었는지 쉽게 구분 할수 있게 해준다.
...
# 데이터 파일을 저장할때 date의 문자값으로 변경한 시간을 넣어서 파일을 저장해주기 때문에 돌릴때마다 저장 되는 파일의 이름은 달라진다.
